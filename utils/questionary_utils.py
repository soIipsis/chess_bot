...
class DateValidator(questionary.Validator):
    ...
    def validate(self, document: Document) -> None:
        from chess_bots.chess_bot.utils.date_utils import parse_date
...
class TimeValidator(questionary.Validator):
    ...
    def validate(self, document: Document) -> None:
        from chess_bots.chess_bot.utils.date_utils import parse_time
...
class TimeRangeValidator(questionary.Validator):
    ...
    def validate(self, document: Document) -> None:
        from chess_bots.chess_bot.utils.date_utils import parse_time_range
